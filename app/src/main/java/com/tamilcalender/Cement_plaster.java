...
public class Cement_plaster extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cement_plaster);
        ...
        adView = findViewById(R.id.adView14);
        ...
        sp4=findViewById(R.id.spinner7);
        sp5=findViewById(R.id.spinner8);
        sp6=findViewById(R.id.spinner9);
        sp7=findViewById(R.id.spinner5);
        ...
        ed6=findViewById(R.id.editTextNumberDecimal5);
        ed7=findViewById(R.id.editTextNumberDecimal13);
        ed8=findViewById(R.id.editTextNumberDecimal14);
        ed9=findViewById(R.id.editTextNumberDecimal15);
        ...
        tx3 = findViewById(R.id.textView773);
        tx4 = findViewById(R.id.textView775);
        tx5 = findViewById(R.id.textView777);
        tx6 = findViewById(R.id.textView779);


        ArrayAdapter adapter = new ArrayAdapter(Cement_plaster.this, android.R.layout.simple_spinner_item, listitems);
        adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp1.setAdapter(adapter);

        ArrayAdapter adapter1 = new ArrayAdapter(Cement_plaster.this, android.R.layout.simple_spinner_item, listitems);
        adapter1.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp2.setAdapter(adapter1);

        ArrayAdapter adapter2 = new ArrayAdapter(Cement_plaster.this, android.R.layout.simple_spinner_item, listitems);
        adapter2.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp3.setAdapter(adapter2);

        ArrayAdapter adapter3 = new ArrayAdapter(Cement_plaster.this, android.R.layout.simple_spinner_item, listitems);
        adapter3.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp4.setAdapter(adapter3);

        ArrayAdapter adapter4 = new ArrayAdapter(Cement_plaster.this, android.R.layout.simple_spinner_item, listitems);
        adapter4.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp5.setAdapter(adapter4);

        ArrayAdapter adapter5 = new ArrayAdapter(Cement_plaster.this, android.R.layout.simple_spinner_item, listitems);
        adapter5.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp6.setAdapter(adapter5);

        ArrayAdapter adapter6 = new ArrayAdapter(Cement_plaster.this, android.R.layout.simple_spinner_item, listitems1);
    ...
    private void answer() {
        answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Float one_cemenet_bag = Float.valueOf(ed6.getText().toString());
                Float window_length = Float.valueOf(ed7.getText().toString());
                Float window_width = Float.valueOf(ed8.getText().toString());
                Float window_thickness = Float.valueOf(ed9.getText().toString());
                ...
                switch (r7) {
                    case "அடி":
                        if (r4.equals("மீட்டர்")) {
                            result4 = (float) (window_length / 0.3048);
                        } else if (r4.equals("கிலோமீட்டர்")) {
                            result4 = (float) (window_length / 0.0003048);
                        } else if (r4.equals("முற்றம்")) {
                            result4 = (float) (window_length / 0.333333333);
                        } else if (r4.equals("இன்ச்")) {
                            result4 = window_length / 12;
                        }  else if (r4.equals("மில்லிமீட்டர்")) {
                            result4 = (float) (window_length / 304.8);
                        }  else if (r4.equals("சென்டிமீட்டர்")) {
                            result4 = (float) (window_length / 30.48);
                        }  else if (r4.equals("கடல் மைல்")) {
                            result4 = (float) (window_length / 0.000164579);
                        }  else if (r4.equals("மைல்")) {
                            result4 = (float) (window_length / 0.000189394);
                        } else {
                            result4 = window_length;
                        }
                        break;
                }
                switch (r7) {
                    case "அடி":
                        if (r5.equals("மீட்டர்")) {
                            result5 = (float) (window_width / 0.3048);
                        } else if (r5.equals("கிலோமீட்டர்")) {
                            result5 = (float) (window_width / 0.0003048);
                        } else if (r5.equals("முற்றம்")) {
                            result5 = (float) (window_width / 0.333333333);
                        } else if (r5.equals("இன்ச்")) {
                            result5 = window_width / 12;
                        }  else if (r5.equals("மில்லிமீட்டர்")) {
                            result5 = (float) (window_width / 304.8);
                        }  else if (r5.equals("சென்டிமீட்டர்")) {
                            result5 = (float) (window_width / 30.48);
                        }  else if (r5.equals("கடல் மைல்")) {
                            result5 = (float) (window_width / 0.000164579);
                        }  else if (r5.equals("மைல்")) {
                            result5 = (float) (window_width / 0.000189394);
                        } else {
                            result5 = window_width;
                        }
                        break;
                }
                switch (r7) {
                    case "அடி":
                        if (r6.equals("மீட்டர்")) {
                            result6 = (float) (window_thickness / 0.3048);
                        } else if (r6.equals("கிலோமீட்டர்")) {
                            result6 = (float) (window_thickness / 0.0003048);
                        } else if (r6.equals("முற்றம்")) {
                            result6 = (float) (window_thickness / 0.333333333);
                        } else if (r6.equals("இன்ச்")) {
                            result6 = window_thickness / 12;
                        }  else if (r6.equals("மில்லிமீட்டர்")) {
                            result6 = (float) (window_thickness / 304.8);
                        }  else if (r6.equals("சென்டிமீட்டர்")) {
                            result6 = (float) (window_thickness / 30.48);
                        }  else if (r6.equals("கடல் மைல்")) {
                            result6 = (float) (window_thickness / 0.000164579);
                        }  else if (r6.equals("மைல்")) {
                            result6 = (float) (window_thickness / 0.000189394);
                        } else {
                            result6 = window_thickness;
                        }
                        break;
                }
                ...
                tx1.setText(String.valueOf(cement_number_bag));
                tx2.setText(String.valueOf(price_cement));
                tx3.setText(String.valueOf(unit_sand));
                tx4.setText(String.valueOf(price_sand));
                tx5.setText(String.valueOf(liter_water));
                tx6.setText(String.valueOf(price_water));


                Toast.makeText(Cement_plaster.this, r1, Toast.LENGTH_LONG).show();
