...
public class volume_conversion_unit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volume_conversion_unit);
        ...
        adView = findViewById(R.id.adView61);
        // Create an ad request
        AdRequest adRequest = new AdRequest.Builder().build();
        // Load the ad into the AdView
        adView.loadAd(adRequest);

        listitems = getResources().getStringArray(R.array.units_volume);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.units_volume, android.R.layout.simple_spinner_item);
        ...
        answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (inputUnitValue) {
                    case "கன_அடி":
                        if (outputUnitValue.equals("கன_மீட்டர்")) {
                            result = inputVal / 35.315;
                        } else if (outputUnitValue.equals("கன_அங்குலம்")) {
                            result = inputVal * 1728;
                        }else {
                            result = inputVal;
                        }
                        break;
                    case "கன_மீட்டர்":
                        if (outputUnitValue.equals("கன_அடி")) {
                            result = inputVal * 35.315;
                        } else if (outputUnitValue.equals("கன_அங்குலம்")) {
                            result = inputVal * 61020;
                        }else {
                            result = inputVal;
                        }
                        break;
                    case "கன_அங்குலம்":
                        if (outputUnitValue.equals("கன_மீட்டர்")) {
                            result = inputVal / 61020;
                        } else if (outputUnitValue.equals("கன_அடி")) {
                            result = inputVal / 1728;
                        }else {
                            result = inputVal;
                        }
