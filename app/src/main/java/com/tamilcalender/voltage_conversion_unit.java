...
public class voltage_conversion_unit extends AppCompatActivity {
    private Button share;
    private AdView adView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_voltage_conversion_unit);
        ...
        adView = findViewById(R.id.adView60);
