...
public class pressure_conversion_unit extends AppCompatActivity {
    private Button share;
    private AdView adView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pressure_conversion_unit);
        ...
        adView = findViewById(R.id.adView36);
