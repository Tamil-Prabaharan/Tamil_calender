...
public class hexagane_shape_weight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hexagane_shape_weight);
        ...
        adView = findViewById(R.id.adView23);
        ...
        sp2=findViewById(R.id.spinner26);
        sp3=findViewById(R.id.spinner82);
        sp4=findViewById(R.id.spinner27);

        ed1=findViewById(R.id.editTextNumberDecimal75);
        ...
        ArrayAdapter adapter = new ArrayAdapter(hexagane_shape_weight.this, android.R.layout.simple_spinner_item, listitems);
        adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp1.setAdapter(adapter);

        ArrayAdapter adapter1 = new ArrayAdapter(hexagane_shape_weight.this, android.R.layout.simple_spinner_item, listitems);
        adapter1.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp2.setAdapter(adapter1);

        ArrayAdapter adapter2 = new ArrayAdapter(hexagane_shape_weight.this, android.R.layout.simple_spinner_item, listitems);
        adapter2.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp3.setAdapter(adapter2);

        ArrayAdapter adapter3 = new ArrayAdapter(hexagane_shape_weight.this, android.R.layout.simple_spinner_item, listitems1);
    ...
    private void answer() {
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Float diameter1 = Float.valueOf(ed1.getText().toString());
                Float diameter2  = Float.valueOf(ed2.getText().toString());
                Float length  = Float.valueOf(ed3.getText().toString());
                Float number = Float.valueOf(ed4.getText().toString());
                ...
                switch (r1) {
                    case "அடி":
                        if (r1.equals("மீட்டர்")) {
                            result1 = (float) (diameter1 / 0.3048);
                        } else if (r1.equals("கிலோமீட்டர்")) {
                            result1 = (float) (diameter1 / 0.0003048);
                        } else if (r1.equals("முற்றம்")) {
                            result1 = (float) (diameter1 / 0.333333333);
                        } else if (r1.equals("இன்ச்")) {
                            result1 = diameter1 / 12;
                        } else if (r1.equals("மில்லிமீட்டர்")) {
                            result1 = (float) (diameter1 / 304.8);
                        } else if (r1.equals("சென்டிமீட்டர்")) {
                            result1 = (float) (diameter1 / 30.48);
                        } else if (r1.equals("கடல் மைல்")) {
                            result1 = (float) (diameter1 / 0.000164579);
                        } else if (r1.equals("மைல்")) {
                            result1 = (float) (diameter1 / 0.000189394);
                        } else {
                            result1 = diameter1;
                        }
                        break;
                ...
                switch (r2) {
                    case "அடி":
                        if (r2.equals("மீட்டர்")) {
                            result2 = (float) (diameter2 / 0.3048);
                        } else if (r2.equals("கிலோமீட்டர்")) {
                            result2 = (float) (diameter2 / 0.0003048);
                        } else if (r2.equals("முற்றம்")) {
                            result2 = (float) (diameter2 / 0.333333333);
                        } else if (r2.equals("இன்ச்")) {
                            result2 = diameter2 / 12;
                        } else if (r2.equals("மில்லிமீட்டர்")) {
                            result2 = (float) (diameter2 / 304.8);
                        } else if (r2.equals("சென்டிமீட்டர்")) {
                            result2 = (float) (diameter2 / 30.48);
                        } else if (r2.equals("கடல் மைல்")) {
                            result2 = (float) (diameter2 / 0.000164579);
                        } else if (r2.equals("மைல்")) {
                            result2 = (float) (diameter2 / 0.000189394);
                        } else {
                            result2 = diameter2;
                        }
                        break;
                ...
                Toast.makeText(hexagane_shape_weight.this, r1, Toast.LENGTH_LONG).show();
