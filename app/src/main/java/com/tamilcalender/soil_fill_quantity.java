...
public class soil_fill_quantity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soil_fill_quantity);

        //todo:banner ads
        // Initialize the Mobile Ads SDK
        MobileAds.initialize(this, initializationStatus -> {});
        // Find the AdView as defined in the XML
        adView = findViewById(R.id.adView42);
        ...
        sp4=findViewById(R.id.spinner67);
        ...
        ArrayAdapter adapter = new ArrayAdapter(soil_fill_quantity.this, android.R.layout.simple_spinner_item, listitems);
        adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp1.setAdapter(adapter);

        ArrayAdapter adapter1 = new ArrayAdapter(soil_fill_quantity.this, android.R.layout.simple_spinner_item, listitems);
        adapter1.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp2.setAdapter(adapter1);

        ArrayAdapter adapter2 = new ArrayAdapter(soil_fill_quantity.this, android.R.layout.simple_spinner_item, listitems);
        adapter2.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp3.setAdapter(adapter2);

        ArrayAdapter adapter3 = new ArrayAdapter(soil_fill_quantity.this, android.R.layout.simple_spinner_item, listitems1);
    ...
    private void answer() {
        answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Float wall_inner_width = Float.valueOf(ed2.getText().toString());
                Float wall_inner_height = Float.valueOf(ed3.getText().toString());
                Float soil_factor = Float.valueOf(ed4.getText().toString());
                Float soil_price = Float.valueOf(ed5.getText().toString());
                float result1 = 0.0F;
                float result2 = 0.0F;
                float result3 = 0.0F;
                ...
                switch (r4) {
                    case "அடி":
                        if (r1.equals("மீட்டர்")) {
                            result1 = (float) (wall_inner_length / 0.3048);
                        } else if (r1.equals("கிலோமீட்டர்")) {
                            result1 = (float) (wall_inner_length / 0.0003048);
                        } else if (r1.equals("முற்றம்")) {
                            result1 = (float) (wall_inner_length / 0.333333333);
                        } else if (r1.equals("இன்ச்")) {
                            result1 = wall_inner_length / 12;
                        } else if (r1.equals("மில்லிமீட்டர்")) {
                            result1 = (float) (wall_inner_length / 304.8);
                        } else if (r1.equals("சென்டிமீட்டர்")) {
                            result1 = (float) (wall_inner_length / 30.48);
                        } else if (r1.equals("கடல் மைல்")) {
                            result1 = (float) (wall_inner_length / 0.000164579);
                        } else if (r1.equals("மைல்")) {
                            result1 = (float) (wall_inner_length / 0.000189394);
                        } else {
                            result1 = wall_inner_length;
                        }
                        break;
                }
                switch (r4) {
                ...
                switch (r4) {
                    case "அடி":
                        if (r3.equals("மீட்டர்")) {
                            result3 = (float) (wall_inner_height / 0.3048);
                        } else if (r3.equals("கிலோமீட்டர்")) {
                            result3 = (float) (wall_inner_height / 0.0003048);
                        } else if (r3.equals("முற்றம்")) {
                            result3 = (float) (wall_inner_height / 0.333333333);
                        } else if (r3.equals("இன்ச்")) {
                            result3 = wall_inner_height / 12;
                        } else if (r3.equals("மில்லிமீட்டர்")) {
                            result3 = (float) (wall_inner_height / 304.8);
                        } else if (r3.equals("சென்டிமீட்டர்")) {
                            result3 = (float) (wall_inner_height / 30.48);
                        } else if (r3.equals("கடல் மைல்")) {
                            result3 = (float) (wall_inner_height / 0.000164579);
                        } else if (r3.equals("மைல்")) {
                            result3 = (float) (wall_inner_height / 0.000189394);
                        } else {
                            result3 = wall_inner_height;
                        }
                        break;
                }

                //Todo:calculate number of steps
                float volume_soil = result1 * result2 * result3;
                float required_quantity = (volume_soil * soil_factor)/100;
                //Todo:calculate price soil
                float volume_soil_price = required_quantity * soil_price ;

                tx1.setText(String.valueOf(required_quantity +" unit"));
                tx2.setText(String.valueOf(volume_soil_price +" price"));

                Toast.makeText(soil_fill_quantity.this, r1, Toast.LENGTH_LONG).show();
