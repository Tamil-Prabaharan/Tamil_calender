...
public class circle_shape_area extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circle_shape_area);
        ...
        adView = findViewById(R.id.adView16);
        ...
        sp2=findViewById(R.id.spinner77);
        ...
        ArrayAdapter adapter = new ArrayAdapter(circle_shape_area.this, android.R.layout.simple_spinner_item, listitems);
        adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp1.setAdapter(adapter);

        ArrayAdapter adapter1 = new ArrayAdapter(circle_shape_area.this, android.R.layout.simple_spinner_item, listitems);
    ...
    private void answer() {
        answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float a  = (float) (3.14 *( result1 * result1));
                float p  = (float) (2*3.14) * result1;

                tx1.setText(String.valueOf(a+" area "));
                tx2.setText(String.valueOf(p+" perimeter "));

                Toast.makeText(circle_shape_area.this, r1, Toast.LENGTH_LONG).show();
