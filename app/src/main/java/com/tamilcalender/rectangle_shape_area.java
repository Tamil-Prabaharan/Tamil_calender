...
public class rectangle_shape_area extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rectangle_shape_area);
        ...
        adView = findViewById(R.id.adView38);
        ...
        sp3=findViewById(R.id.spinner73);
        ...
        ArrayAdapter adapter = new ArrayAdapter(rectangle_shape_area.this, android.R.layout.simple_spinner_item, listitems);
        adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp1.setAdapter(adapter);

        ArrayAdapter adapter1 = new ArrayAdapter(rectangle_shape_area.this, android.R.layout.simple_spinner_item, listitems);
        adapter1.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp2.setAdapter(adapter1);

        ArrayAdapter adapter2 = new ArrayAdapter(rectangle_shape_area.this, android.R.layout.simple_spinner_item, listitems1);
    ...
    private void answer() {
        answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Todo:calculate rectangle shape
                float p  = 2*(result1 + result2);
                float a  = (result1 * result2);

                tx1.setText(String.valueOf(a+" area "));
                tx2.setText(String.valueOf(p+" perimeter "));

                Toast.makeText(rectangle_shape_area.this, r1, Toast.LENGTH_LONG).show();
