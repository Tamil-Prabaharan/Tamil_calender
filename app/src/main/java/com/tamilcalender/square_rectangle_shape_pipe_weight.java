...
public class square_rectangle_shape_pipe_weight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_square_rectangle_shape_pipe_weight);

        //todo:banner ads
        // Initialize the Mobile Ads SDK
        MobileAds.initialize(this, initializationStatus -> {});
        // Find the AdView as defined in the XML
        adView = findViewById(R.id.adView44);
        ...
        sp3=findViewById(R.id.spinner31);
        ...
        ed3=findViewById(R.id.editTextNumberDecimal54);
        ...
        ArrayAdapter adapter = new ArrayAdapter(square_rectangle_shape_pipe_weight.this, android.R.layout.simple_spinner_item, listitems);
        adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp1.setAdapter(adapter);

        ArrayAdapter adapter1 = new ArrayAdapter(square_rectangle_shape_pipe_weight.this, android.R.layout.simple_spinner_item, listitems);
        adapter1.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp2.setAdapter(adapter1);

        ArrayAdapter adapter2 = new ArrayAdapter(square_rectangle_shape_pipe_weight.this, android.R.layout.simple_spinner_item, listitems);
        adapter2.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp3.setAdapter(adapter2);

        ArrayAdapter adapter3 = new ArrayAdapter(square_rectangle_shape_pipe_weight.this, android.R.layout.simple_spinner_item, listitems1);
    ...
    private void answer() {
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Todo:calculate
                float volume  = (result1 * result2 * result3);
                ...
                Toast.makeText(square_rectangle_shape_pipe_weight.this, r1, Toast.LENGTH_LONG).show();
