...
public class allipse_shape_area extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allipse_shape_area);
        ...
        sp3=findViewById(R.id.spinner75);
        ...
        ArrayAdapter adapter = new ArrayAdapter(allipse_shape_area.this, android.R.layout.simple_spinner_item, listitems);
        adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp1.setAdapter(adapter);

        ArrayAdapter adapter1 = new ArrayAdapter(allipse_shape_area.this, android.R.layout.simple_spinner_item, listitems);
        adapter1.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp2.setAdapter(adapter1);

        ArrayAdapter adapter2 = new ArrayAdapter(allipse_shape_area.this, android.R.layout.simple_spinner_item, listitems1);
    ...
    private void answer() {
        answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float a  = (float) (3.14 * result1 * result2);
                float p  = (float) ((float) (2*3.14)*(Math.sqrt(((result1 * result1)+(result2 * result2))/2)));

                tx1.setText(String.valueOf(a+" area "));
                tx2.setText(String.valueOf(p+" perimeter "));

                Toast.makeText(allipse_shape_area.this, r1, Toast.LENGTH_LONG).show();
