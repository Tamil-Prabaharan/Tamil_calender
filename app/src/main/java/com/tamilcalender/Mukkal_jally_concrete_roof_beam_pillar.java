...
public class Mukkal_jally_concrete_roof_beam_pillar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mukkal_jally_concrete_roof_beam_pillar);

        //todo:banner ads
        // Initialize the Mobile Ads SDK
        MobileAds.initialize(this, initializationStatus -> {});
        // Find the AdView as defined in the XML
        adView = findViewById(R.id.adView27);
        ...
        sp1=findViewById(R.id.spinner41);
        sp2=findViewById(R.id.spinner42);
        sp3=findViewById(R.id.spinner43);
        sp4=findViewById(R.id.spinner70);
        ...
        ed6=findViewById(R.id.editTextNumberDecimal68);
        ...
        ArrayAdapter adapter = new ArrayAdapter(Mukkal_jally_concrete_roof_beam_pillar.this, android.R.layout.simple_spinner_item, listitems);
        adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp1.setAdapter(adapter);

        ArrayAdapter adapter1 = new ArrayAdapter(Mukkal_jally_concrete_roof_beam_pillar.this, android.R.layout.simple_spinner_item, listitems);
        adapter1.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp2.setAdapter(adapter1);

        ArrayAdapter adapter2 = new ArrayAdapter(Mukkal_jally_concrete_roof_beam_pillar.this, android.R.layout.simple_spinner_item, listitems);
        adapter2.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        sp3.setAdapter(adapter2);

        ArrayAdapter adapter3 = new ArrayAdapter(Mukkal_jally_concrete_roof_beam_pillar.this, android.R.layout.simple_spinner_item, listitems1);
    ...
    private void answer() {
        answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float cement_kg  = (float) (cement / tatal_ratio) * pcc_volume  ;
                //Todo:calculate no bags
                float no_bags  = (float) (cement_kg / 1.25) ;
                //Todo:calculate sand
                float sand_volume  = (float) (sand / tatal_ratio) * pcc_volume;
                float sand_volume_unit  = (float) sand_volume  / 100;
                //Todo:calculate aggregate
                float aggregate_volume  = (float) (aggregate / tatal_ratio) * pcc_volume;
                float aggregate_volume_unit  = (float) aggregate_volume  / 100;
